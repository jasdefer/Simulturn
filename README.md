...
- Initialization
  - Each player starts with a headquarter building, 3 workers on a single hexagon
...
- Prerequisites
  - Enough supply
  - Enough resources
  - an idle unit training building
...
- Construction
  ...
  - Cancelled construction is removed and resources reimbursed
- Training
...
- Combat
  ...
  - A combat always results in a single winning player, every other player loses all units
...
- Resource depletion: Resources can be harvested until all available resources have been harvested on that pile
...
- Sync Games:
  - Each player has a fixed amount of time for all his turns

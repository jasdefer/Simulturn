    ...
    int Seed = 1)
{
    ...
    public static GameSettings Default(int seed = 1)
    {
        ...
        {
            { new Coordinates(-2,+0), new HexagonSettings(10000, points, true, false) },
            { new Coordinates(-2,+1), new HexagonSettings(10000, points, true, false) },
            { new Coordinates(-2,+2), new HexagonSettings(10000, points, true, false) },
            { new Coordinates(-1,-1), new HexagonSettings(10000, points, true, false) },
            { new Coordinates(-1,+0), new HexagonSettings(10000, points, true, false) },
            { new Coordinates(-1,+1), new HexagonSettings(10000, points, true, false) },
            { new Coordinates(-1,+2), new HexagonSettings(10000, points, true, true) },
            { new Coordinates(+0,-2), new HexagonSettings(10000, points, true, false) },
            { new Coordinates(+0,-1), new HexagonSettings(10000, points, true, false) },
            { new Coordinates(+0,+0), new HexagonSettings(10000, points, true, false) },
            { new Coordinates(+0,+1), new HexagonSettings(10000, points, true, false) },
            { new Coordinates(+0,+2), new HexagonSettings(10000, points, true, false) },
            { new Coordinates(+1,-2), new HexagonSettings(10000, points, true, true) },
            { new Coordinates(+1,-1), new HexagonSettings(10000, points, true, false) },
